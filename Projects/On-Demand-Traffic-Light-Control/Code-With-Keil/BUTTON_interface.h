...
/*************** Date        : 20 Sep 2023            ***************/
/*************** Version     : 0.1                    ***************/
/*************** Module Name : BUTTON_interface.h     ***************/
/*************** Layer       : HAL                    ***************/
/********************************************************************/
 ...
 */
#define DEBOUNCE_DELAY_MS 200 /**< Define a debounce delay in milliseconds (adjust as needed) */
 ...
 * @param[in] Copy_ButtonPortId The ID of the GPIO port (e.g., GPIO_PORTA, GPIO_PORTB, etc.).
 * @param[in] Copy_ButtonPinId  The ID of the GPIO pin (e.g., GPIO_PIN0, GPIO_PIN1, etc.).
 * @param[in] numIterations     Repeat the reading and debouncing for the specified number of iterations.
